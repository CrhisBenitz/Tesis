...
plt.plot(zz,[rho(3.,z) for z in zz],c='k',ls='--',label='$r=3$ kpc')
plt.plot(zz,[rho(8.,z) for z in zz],c='k',label='$r=8$ kpc')
plt.plot(zz,[rho(10.,z) for z in zz],c='k',ls=':',label='$r=10$ kpc')
